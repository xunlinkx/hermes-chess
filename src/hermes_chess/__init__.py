...
def _slash_handler(raw_args: str) -> str:
    ...
    try:
        ...
        return "Invalid /chess arguments. Try /chess help."
    if not parts:
        return (
            "Chess commands: /chess start [difficulty] [white|black|random], "
            ...
            "/chess decline_draw, /chess pgn, /chess rematch, /chess help"
    ...
    if action == "move":
        ...
        "get_difficulty", "pgn", "list_games", "help",
    }:
    ...
    if not result.get("success"):
        return str(result.get("error") or "Chess command failed.")
